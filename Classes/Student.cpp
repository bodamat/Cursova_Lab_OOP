...
void Student::operator()(const Person& person)
{
...
void Student::operator()(string vnz, string faculty, int course, string group)
{
    set_vnz(vnz);
    set_faculty(faculty);
    set_course(course);
...
void Student::operator()(int lessons_count, STMarkFromLesson* lessons_mark)
{
    set_lessons_count(lessons_count);
